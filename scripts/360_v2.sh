...
CUDA_VISIBLE_DEVICES=1 python train.py --gs_source output/garden/point_cloud/iteration_5000/point_cloud.ply --colmap_dir data/360_v2/garden --images images_4
