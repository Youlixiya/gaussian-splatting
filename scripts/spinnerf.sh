...
#pinecone
CUDA_VISIBLE_DEVICES=1 python train_gs.py --source_path data/nerf_real_360/pinecone --images images_8 --iterations 5000 --model_path output/nerf_real_360/pinecone
CUDA_VISIBLE_DEVICES=1 python train.py --gs_source output/nerf_real_360/pinecone/point_cloud/iteration_5000/point_cloud.ply --colmap_dir data/nerf_real_360/pinecone --images images_8

#truck
CUDA_VISIBLE_DEVICES=1 python train_gs.py --source_path data/tandt/truck --images images_8 --iterations 5000 --model_path output/tandt/truck
CUDA_VISIBLE_DEVICES=1 python train.py --gs_source output/tandt/truck/point_cloud/iteration_5000/point_cloud.ply --colmap_dir data/tandt/truck --images images_8
python metrics_spinnerf.py --cfg_path scripts/batch_contrastive_spinnerf_test_config.json --gt_path data/Multiview-Segmentation-Data --save_tag spinnerf_batch_contrastive